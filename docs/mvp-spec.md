...
Можно выбрать галочкой "Лёгкий режим (3 жизни)", тогда пользователь может сделать 3 ошибки прежде, чем проиграет и игра закончится.
...
Доска лучших по времени игры результатов.
